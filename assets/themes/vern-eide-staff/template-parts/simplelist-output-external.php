<?php
global $staff, $listid;
//delete_transient('simplelist_'.$listid.'_output_external_transient');
$cached_output = get_transient('simplelist_'.$listid.'_output_external_transient');
...
global $debug, $listinglocations, $locationtaxonomy, $notvisible, $internal, $birthdaylist, $newpromotionlist, $newmonthsprior, $bddaysbeforetoday, $bddaysaftertoday;
...
// STORE CACHE
    ...
    set_transient('simplelist_'.$listid.'_output_external_transient', $staff, 12 * 60 * 60); // Lasts for 12 hours
} // END CACHE CHECK