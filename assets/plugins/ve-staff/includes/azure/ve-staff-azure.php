...
function ve_staff_azure_settings_page(): void {
	...
	echo '<option value="organizationalUnit"></option></datalist><div class="ve-azure-mappings-scroll" tabindex="0"><table class="widefat striped" id="ve-azure-mappings"><thead><tr><th>Azure field</th><th>WordPress target</th><th>Source of truth</th><th>Rules (JSON array)</th><th></th></tr></thead><tbody>';
