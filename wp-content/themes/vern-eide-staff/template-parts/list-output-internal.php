...
$cached_output = get_transient('list_'.$listid.'_output_internal_transient');
...
global $output, $dept_taxonomy_terms, $depttaxonomy, $locationtaxonomy, $listinglocations, $notvisible, $showdepartments, $showtitles, $internal, $showbios, $listid, $listingtype;
    ...
    foreach($dept_taxonomy_terms as $dept_taxonomy_term) {
        ...
        foreach( $posts as $post ) {    // Pluck the id and title attributes
			...
			if($internal){
				...
				$yearsofservice = get_field('anniversary_years_service_current');
...
// STORE CACHE
    ...
    set_transient('list_'.$listid.'_output_internal_transient', $output, 12 * 60 * 60); // Lasts for 12 hours
} // END CACHE CHECK